...
//                                                            if tododata[index].Sec >= 0{
//                                                                Text("\(tododata[index].Sec)秒")
//                                                                    .foregroundStyle(Color.blackGray)
//                                                                    .padding(.bottom, 0.5)
//                                                                    .padding(.horizontal, -3)
//                                                                    .bold()
...
//                                                                    if decomposeSeconds(totalSeconds: tododata[index].actualFinishTime).seconds != 0{
//                                                                        Text("\(decomposeSeconds(totalSeconds: tododata[index].actualFinishTime).seconds)秒")
//                                                                            .foregroundStyle(Color.blackGray)
//                                                                            .padding(.bottom, 0.5)
//                                                                            .padding(.horizontal, -3)
//                                                                            .bold()
...
//                                                                    if decomposeSeconds(totalSeconds: tododata[index].leftTime).seconds != 0{
//                                                                        Text("\(decomposeSeconds(totalSeconds: tododata[index].leftTime).seconds)秒")
//                                                                            .foregroundStyle(Color.blackGray)
//                                                                            .padding(.bottom, 0.5)
//                                                                            .padding(.horizontal, -3)
//                                                                            .bold()
...
//                                        .labelsHidden()
        ...
        .onAppear{
            if #available(iOS 18.0, *) {
                Task { await EmergencyViewTip.emergencyViewEvent.donate() }
                Task { await EmergencyViewTip.emergencyViewEvent.donate() }
            } else {
                Task { await EmergencyViewTip.emergencyViewEvent.donate() }
            }
