//
//  VersionSchemaV5.swift
//  DeadLineTodo
//
//  Created by Andy on 2024/3/19.
//
...
enum TodoDataSchemaV5: @preconcurrency VersionedSchema {
    ...
    @MainActor static var versionIdentifier: Schema.Version = .init(2, 2, 3)
}

extension TodoDataSchemaV5 {
    @Model
    ...
    class UserSetting: Identifiable {
        ...
        init(frequency: Int, reminder: Bool) {
