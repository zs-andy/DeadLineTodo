...
public struct ContributionChartView: View {
    ...
    var heatMapRectangleWidth: Double = 19.0
    var heatMapRectangleSpacing: Double = 2.0
    var heatMapRectangleRadius: Double = 6.0
    ...
    public init(data: [Double], rows: Int, columns: Int, targetValue: Double, blockColor: Color = Color.green, RectangleWidth: Double = 19.0, RectangleSpacing: Double = 2.0, RectangleRadius: Double = 6.0){
        self.data = data
        self.rows = rows
        self.columns = columns
        self.targetValue = targetValue
